export default function Pricing() {
  return (
    <section className="section" id="pricing">
      ...
      <h2 className="section-title reveal">Start free. Scale when you need to.</h2>
      <p className="section-sub reveal">
        Demo mode is free with no account required. Bring your own Anthropic key for unlimited
        generation. Paid tiers coming soon.
      </p>
      ...
      <div className="pricing-grid">
        <div className="pricing-card reveal">
          ...
          <p className="pricing-desc">No account. No API key. See it work before you commit.</p>
          ...
          <a href="https://app.kaminify.com" className="btn-pricing-secondary">Try demo</a>
        </div>

        <div className="pricing-card featured reveal">
          <div className="pricing-badge">Available now</div>
          <span className="pricing-tier">BYOK</span>
          <div className="pricing-price">Free <span>with your key</span></div>
          ...
          <a href="https://app.kaminify.com" className="btn-pricing-primary">Get started free</a>
        </div>
        ...
        <div className="pricing-card reveal">
          ...
          <a href="mailto:hello@kaminify.com" className="btn-pricing-secondary">Join waitlist</a>
        </div>
      </div>
    </section>
  )
